...
def test_provider_uses_single_date_batch_request_for_multiple_symbols(tmp_path: Path) -> None:
    client = StaticClient()
    ...
    assert client.calls == [
        FinMindRequest("TaiwanStockTradingDate", None, date(2024, 1, 2), date(2024, 1, 4))
    ]
